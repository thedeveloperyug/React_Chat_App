...
const Message = ({ message }) => {
  ...
  return (
    ...
    <div ref={ref} className={`msg ${message.senderId === currentUser.uid && "owner"}`}>
      <div className='messageInfo px-2  '>
        <img src={message.senderId === currentUser.uid ? currentUser.uid : data.user.photoURL} className='w-12 rounded-full' alt="" />
