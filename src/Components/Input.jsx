      ...
      <div>
        <div className='flex space-x-2 items-center'>
          <div className=' w-full'>
            <input onChange={e => setText(e.target.value)} value={text} type="text" className='py-2 w-full focus:outline-slate-300 font-Poppins font-medium px-4 mx-1 rounded bg-gray-200 placeholder-gray-500' placeholder='Enter Messages' />
          </div>
          <div className='flex cursor-pointer items-center'>
            <div className='space-x-1 cursor-pointer  flex items-center'>
              <div className='p-1 hover:bg-yellow-300 hover:rounded-full'>
              <input type="file" className='w-72' name="" id="file" onChange={e => setImg(e.target.files[0])} style={{ display: "none" }} />
              <label htmlFor="file"><svg viewBox="0 0 24 24" className='h-6' fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 7.90909V16C6 19.3137 8.68629 22 12 22V22C15.3137 22 18 19.3137 18 16V6C18 3.79086 16.2091 2 14 2V2C11.7909 2 10 3.79086 10 6V15.1818C10 16.2864 10.8954 17.1818 12 17.1818V17.1818C13.1046 17.1818 14 16.2864 14 15.1818V8" stroke="#817e7e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>   </label>
              </div>
              <div className='p-1 items-center flex mt-1  hover:bg-yellow-300 hover:rounded-full'>
            ...
            <button  onClick={handleSend} className='hover:bg-yellow-400 hover:rounded-full'>
